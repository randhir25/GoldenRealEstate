    ...
    <b-navbar toggleable="md" type="dark" class="jh-navbar">
        <div>
            ...
            <b-navbar-brand class="logo float-left" b-link to="/">
                ...
                <span v-text="$t('global.title')" class="navbar-title">Golden Real Estate</span>
            ...
            <b-navbar-nav class="ml-auto">
                ...
                <b-nav-item-dropdown
                    ...
                    <span slot="button-content" class="navbar-dropdown-menu">
                        ...
                        <span v-text="$t('global.menu.reports.main')">Reports</span>
                    </span>
                    <b-dropdown-item to="/todosreport">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.reports.todosReport')">Project</span>
                    </b-dropdown-item>
                </b-nav-item-dropdown>
                <b-nav-item-dropdown
                    id="entity-menu"
                    ...
                    <b-dropdown-item to="/building">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.building')">Building</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/unit">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.unit')">Unit</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/todos">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.todos')">Todos</span>
                    </b-dropdown-item>
