    ...
    <div class="row justify-content-center">
        <div class="col-8">
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                <h2 id="goldenRealEstateApp.region.home.createOrEditLabel" v-text="$t('goldenRealEstateApp.region.home.createOrEditLabel')">Create or edit a Region</h2>
                <div>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('goldenRealEstateApp.region.regionName')" for="region-regionName">Region Name</label>
